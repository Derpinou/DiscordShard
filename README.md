## Introduction
Bonjour, si vous êtes développeur de bot.s Discord, vous avez sans doute entendu parler des `shards`.
...
J'ai fait ce tuto, car peu de tutoriels sur les shards en francais existent, et je suis bien placé pour en parler sachant que je suis repsonsable de l'infrastructure et du développement d'un bot comptant plusieurs dizaines de milliers de serveurs discord.
...
Sur des serveurs d'entraides de développement, vous verrez beaucoup passer des gens qui disent UN ou UNE shard, et bien on ne sais pas trop, on pourrais dire que une shard est une instance, donc au féminin, on pourrait aussi dire que les shards sont des Clients Discord eux même, donc au masculin.
Du point de vue de la traduction, on remarque que toutes les traductions sont masculines (selon [Larousse](https://www.larousse.fr/dictionnaires/anglais-francais/shard/611062)).
